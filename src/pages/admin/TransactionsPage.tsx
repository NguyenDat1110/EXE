...
import TransactionMonitor from '../../components/admin-dashboard/TransactionMonitor';

export default function TransactionsPage({ navigate, pageParams }: { navigate: (page: string, params?: any) => void, pageParams: any }) {
  return (
    <>
      <div className="grain-overlay"></div>
      <div className="min-h-screen bg-background-dark text-slate-100 flex">
        <AdminSidebar navigate={navigate} currentPage="admin-transactions" />
        ...
        <main className="flex-1 flex flex-col min-w-0">
          ...
          <header className="sticky top-0 z-40 bg-background-dark/80 backdrop-blur-md border-b border-white/10 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-white hidden sm:block">Quản Lý Giao Dịch</h1>
            </div>
